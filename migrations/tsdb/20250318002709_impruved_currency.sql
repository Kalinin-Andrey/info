...
ALTER TABLE cmc.currency ADD COLUMN circulating_supply  bigint              null;
ALTER TABLE cmc.currency ADD COLUMN total_supply        bigint              null;
ALTER TABLE cmc.currency ADD COLUMN max_supply          bigint              null;
